...
$(function(){
	...
	//별점 테이블 생성
	var starArr = new Array(); //별점 배열 생성
	var noArr = new Array(); //place_no 배열 생성
	<c:forEach var="sDTO" items="${place }">
	...
	$("#reviewForm").submit(function(){
		...
		if(testArr.length==1){ //페이지에 헤더의 이미지만 있을 경우
...
<div class="container">
<br><br>
	<form method="post" action="reviewWriteOk" id="reviewForm" enctype="multipart/form-data">
		<input type="hidden" name="plan_no" id="plan_no" value="${dto.plan_no }">
