...
$(function(){
 ...
 <div class="container_find">
	<div class="findBox">
			<h1>비밀번호 찾기</h1>
			<!-- 비밀번호 찾기 폼 -->
			<form name="pwdFindForm" action="findPwdResult" method = "POST">
				<!-- 이름 -->
				<div class="name_box">
				...
				<!-- 아이디 -->
				<div class="id_box">
					<p class="find_box_size" align="left">아이디</p>
					<input type="text" name="id" id="id" placeholder="아이디를 입력해 주세요."  class="find_box_size"/>
				</div>
				<!-- 전화번호 -->
				<div class="phone_box">
